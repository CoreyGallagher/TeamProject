...
public class ASJtableHDSelect extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		//jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "MANGCP701", "ALGSCP701", "DATACP701" }));
		...
		jButton1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				DeptHeadView DptView = new DeptHeadView();
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				...
				.addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
						...
						.addGroup(jPanel1Layout.createSequentialGroup().addGap(112, 112, 112).addComponent(jButton1,
								javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGroup(jPanel1Layout.createSequentialGroup().addGap(64, 64, 64).addComponent(jLabel3,
	...
	public static void main(String args[]) {
		try {
			...
			java.util.logging.Logger.getLogger(ASJtableHDSelect.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
